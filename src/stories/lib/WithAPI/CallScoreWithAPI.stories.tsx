...
import { CallScoreWithAPI } from '../../../../lib/components/WithAPI/CallScoreWithAPI';
import {ACCESS_TOKEN, CONVERSATION_ID, INVALID_CONVERSATION_ID} from "../contants.ts";

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
    title: 'v0.0.0/WithAPI/CallScoreWithAPI',
    component: CallScoreWithAPI,
    parameters: {
...
} satisfies Meta<typeof CallScoreWithAPI>;
