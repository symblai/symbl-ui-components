...
import { MeetingHeaderWithAPI } from '../../../../lib/components/WithAPI/MeetingHeaderWithAPI';
import {ACCESS_TOKEN, CONVERSATION_ID, INVALID_CONVERSATION_ID} from "../contants.ts";

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
    title: 'v0.0.0/WithAPI/MeetingHeaderWithAPI',
    component: MeetingHeaderWithAPI,
    parameters: {
...
} satisfies Meta<typeof MeetingHeaderWithAPI>;
